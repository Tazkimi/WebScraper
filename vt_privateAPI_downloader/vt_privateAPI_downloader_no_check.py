...
API_KEY = 'a62f8e612cd6f0aa125444be0b1479bf6bdb088d42c1577d1a546d8c8654b7d8'
...
logging.basicConfig(level=LOGGING_LEVEL,
                    ...
                    datefmt='%Y-%m-%d %H:%M:%S',
                    stream=sys.stdout)
#  127.0.0.1:1080/pac?t=20171102095800713&secret=rz/nb97pouJIODIo6ywe2K+/OvO4OfCpHUYgGA7F28g=
# proxyIP={'http':'127.0.0.1:1080/pac?t=20171102095800713&secret=rz/nb97pouJIODIo6ywe2K+/OvO4OfCpHUYgGA7F28g='}
# 使用代理IP
...
python %prog -n 10 -f VT (type:doc or type:docx or type:xls or type:xlsx) (tag:exploit or tag:cve) positives:20+ size:20KB+
